...
HEDGE_MARKERS = ["may","might","could","possibly","perhaps","generally","in most cases","usually","often","depends","varies","consult","recommend","suggest","consider","typically","seek professional","talk to a","speak with","check with","seek a second","second opinion","advise","is recommended","evaluation is","is advised","it is suggested","you may want","consider seeking","it is important to consult","before making","always check","free to seek","provide support","seek help","reach out","helpline","crisis line","confidential support"]
